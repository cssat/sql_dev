CREATE PROCEDURE [prtl].[log_query_ooh_wb_family_settings]
...
SET @qry_id = (
		SELECT TOP 1 qry_id
		FROM prtl.ooh_wb_family_settings_params
...
IF @qry_Id IS NULL
BEGIN
	INSERT INTO prtl.ooh_wb_family_settings_params (
		age_grouping_cd
		,pk_gender
		,cd_race_census
...
ELSE
BEGIN
	UPDATE prtl.ooh_wb_family_settings_params
