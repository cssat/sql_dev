...
SELECT m.qry_type [qry_type_poc2]
	...
	,m.cd_finding
	,m.bin_dependency_cd
	,m.jit_entries [Number of Entries]
...
INNER JOIN ref.vw_los_lag ll ON ll.bin_los_cd = m.bin_los_cd
	AND ll.date_type = m.date_type
	AND m.start_date <= ll.max_filter_date
