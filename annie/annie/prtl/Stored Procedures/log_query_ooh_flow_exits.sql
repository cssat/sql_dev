CREATE PROCEDURE [prtl].[log_query_ooh_flow_exits]
...
WHERE id = 25; -- sp_ooh_flow_exits

SET @qry_id = (
		SELECT TOP 1 qry_id
		FROM prtl.ooh_flow_exits_params
...
IF @qry_Id IS NULL
BEGIN
	INSERT INTO prtl.ooh_flow_exits_params (
		age_grouping_cd
		,pk_gender
		,cd_race_census
...
ELSE
BEGIN
	UPDATE prtl.ooh_flow_exits_params
