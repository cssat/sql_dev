CREATE TABLE [prtl].[cache_ooh_outcomes_params]
(
    [qry_id] INT NOT NULL IDENTITY(1,1) 
        CONSTRAINT [pk_cache_ooh_outcomes_params] PRIMARY KEY, 
    ...
    CONSTRAINT [idx_cache_ooh_outcomes_params] UNIQUE NONCLUSTERED (
        [age_grouping_cd], 
        [cd_race_census], 
        [pk_gender], 
        [init_cd_plcm_setng], 
