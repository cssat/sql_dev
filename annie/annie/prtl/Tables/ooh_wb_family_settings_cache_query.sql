CREATE TABLE [prtl].[ooh_wb_family_settings_cache_query] (
...
CREATE NONCLUSTERED INDEX [idx_ooh_wb_family_settings_cache_query] ON [prtl].[ooh_wb_family_settings_cache_query] (
	[age_grouping_cd]
	,[pk_gender]
	,[cd_race_census]
