...
if object_ID('tempDB..##myTbl7') is not null drop table ##myTbl7
create table ##myTbl7(int_researchID int not null
...
begin
		...
		-- insert NEW records						
		insert into ##myTbl7 (int_researchID,DistrictID,SchoolCode,DateEnrolledInDistrict
...
if object_ID(N'ospi.Enrollment_2007',N'U') is not null drop table ospi.Enrollment_2007
select * ,cast(null as int) as row_num into ospi.Enrollment_2007 from ##myTbl7 


ALTER TABLE [ospi].Enrollment_2007 ADD  CONSTRAINT [PK_ospi_ye2007] PRIMARY KEY CLUSTERED 
(
	[int_researchID] ASC,
	[DistrictID] ASC,
	[SchoolCode] ASC,
