...
if object_ID('tempDB..##myTbl6') is not null drop table ##myTbl6
create table ##myTbl6(int_researchID int not null
...
begin
		...
		-- insert NEW records						
		insert into ##myTbl6 (int_researchID,DistrictID,SchoolCode,DateEnrolledInDistrict
...
if object_ID(N'ospi.Enrollment_2006',N'U') is not null drop table ospi.Enrollment_2006
select * ,cast(null as int) as row_num into ospi.Enrollment_2006 from ##myTbl6 


ALTER TABLE [ospi].Enrollment_2006 ADD  CONSTRAINT [PK_ospi_ye2006] PRIMARY KEY CLUSTERED 
(
	[int_researchID] ASC,
	[DistrictID] ASC,
	[SchoolCode] ASC,
