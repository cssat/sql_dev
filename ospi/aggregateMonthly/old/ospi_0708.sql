...
if object_ID('tempDB..##myTbl8') is not null drop table ##myTbl8
create table ##myTbl8(int_researchID int not null
...
begin
		...
		-- insert NEW records						
		insert into ##myTbl8 (int_researchID,DistrictID,SchoolCode,DateEnrolledInDistrict
...
if object_ID(N'ospi.Enrollment_2008',N'U') is not null drop table ospi.Enrollment_2008
select * ,cast(null as int) as row_num into ospi.Enrollment_2008 from ##myTbl8 


ALTER TABLE [ospi].Enrollment_2008 ADD  CONSTRAINT [PK_ospi_ye2008] PRIMARY KEY CLUSTERED 
(
	[int_researchID] ASC,
	[DistrictID] ASC,
	[SchoolCode] ASC,
