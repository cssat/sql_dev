USE [CA_ODS]
GO
/****** Object:  StoredProcedure [base].[prod_build_tbls_ihs_episode_services]    Script Date: 11/4/2013 11:13:19 AM ******/
SET ANSI_NULLS ON
GO
...
--- sort your data
		...
		INCLUDE ([ID_INTAKE_FACT],[rfrd_date],[id_table_origin],[max_id_table_origin],[cnt_id_table_origin],[ihs_end_date],[case_sort],[first_ihs_date],[latest_ihs_date],[fl_plcmnt_prior_ihs],[fl_plcmnt_during_ihs],[plcmnt_date],[cd_office],[tx_office],[days_from_rfrd_date],[nbr_svc_paid],[total_amt_paid],[most_exp_cd_srvc],[most_exp_tx_srvc],[total_most_exp_srvc],[fl_family_focused_services],[fl_child_care],[fl_therapeutic_services],[fl_mh_services],[fl_receiving_care],[fl_family_home_placements],[fl_behavioral_rehabiliation_services],[fl_other_therapeutic_living_situations],[fl_specialty_adolescent_services],[fl_respite],[fl_transportation],[fl_clothing_incidentals],[fl_sexually_aggressive_youth],[fl_adoption_support],[fl_various],[fl_medical],[fl_budget_C12],[fl_budget_C14],[fl_budget_C15],[fl_budget_C16],[fl_budget_C18],[fl_budget_C19],[fl_uncat_svc],[cd_asgn_type],[tx_asgn_type],[fl_force_end_date],[tbl_origin],[tbl_origin_cd],[frst_IHS_after_intk])
...
/******************************************** MERGE    ***********************************/		
		...
		INCLUDE ([id_case],[id_intake_fact],[rfrd_date],[case_nxt_intake],[days_from_rfrd_date],[min_id_payment_fact],[max_id_payment_fact],[cnt_id_table_origin],[srvc_dt_begin],[srvc_dt_end],[first_ihs_date],[latest_ihs_date],[fl_plcmnt_prior_ihs],[fl_plcmnt_during_ihs],[plcmnt_date],[cd_office],[tx_office],[nbr_svc_paid],[total_amt_paid],[most_exp_cd_srvc],[most_exp_tx_srvc],[total_most_exp_srvc],[fl_family_focused_services],[fl_child_care],[fl_therapeutic_services],[fl_mh_services],[fl_receiving_care],[fl_family_home_placements],[fl_behavioral_rehabiliation_services],[fl_other_therapeutic_living_situations],[fl_specialty_adolescent_services],[fl_respite],[fl_transportation],[fl_clothing_incidentals],[fl_sexually_aggressive_youth],[fl_adoption_support],[fl_various],[fl_medical],[fl_budget_C12],[fl_budget_C14],[fl_budget_C15],[fl_budget_C16],[fl_budget_C18],[fl_budget_C19],[fl_uncat_svc],[fl_force_end_date],[tbl_origin],[tbl_origin_cd],[frst_IHS_after_intk])
		...
		cd_office int NULL,tx_office varchar(200) NULL,nbr_svc_paid int NOT NULL,total_amt_paid numeric(18, 2) NULL,most_exp_cd_srvc int NULL,most_exp_tx_srvc varchar(200) NULL,
		total_most_exp_srvc numeric(18, 2) NULL,fl_family_focused_services int NULL,fl_child_care int NULL,fl_therapeutic_services int NULL,fl_mh_services int NULL,
		fl_receiving_care int NULL,fl_family_home_placements int NULL,fl_behavioral_rehabiliation_services int NULL,fl_other_therapeutic_living_situations int NULL,fl_specialty_adolescent_services int NULL,
		fl_respite int NULL,fl_transportation int NULL,fl_clothing_incidentals int NULL,fl_sexually_aggressive_youth int NULL,fl_adoption_support int NULL,
		fl_various int NULL,fl_medical int NULL,fl_budget_C12 int NULL,fl_budget_C14 int NULL,fl_budget_C15 int NULL,fl_budget_C16 int NULL,
	...
	-- update office service flags & budget codes		
...
/***************************************************  FINAL TABLE **/
			...
			from (
			 ...
			 --join (select *,row_number() over (partition by id_case order by ihs_begin_date) as row_num from #tmp_eps) ihs 
				--on ihs.row_num=1
				--	and ihs.id_case=qry.id_case and  (ihs.ihs_begin_date between qry.ihs_begin_date and qry.ihs_end_date
				--	and ihs.ihs_end_date between qry.ihs_begin_date and qry.ihs_end_date)
			 --join (select *,row_number() over (partition by id_case order by srvc_dt_begin) as row_num from #tmp_srvc) srvc 
				--	on srvc.row_num=1 and srvc.id_case=qry.id_case and  (srvc.srvc_dt_begin between qry.ihs_begin_date and qry.ihs_end_date
				--		and srvc.srvc_dt_end between qry.ihs_begin_date and qry.ihs_end_date);
			...
			set 		
				  ...
				  , cd_office= ihs.cd_office
				  , tx_office= ihs.tx_office
			...
			set		ID_INTAKE_FACT = srvc.ID_INTAKE_FACT
				 ...
				 , frst_IHS_after_intk= srvc.frst_IHS_after_intk	
				  ...
				  ,cd_office=srvc.cd_office
				  ,tx_office=srvc.tx_office
			from #tbl_both bth
