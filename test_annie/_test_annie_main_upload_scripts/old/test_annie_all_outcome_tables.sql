...
select 'cache_qry_param_outcomes' as table_name,count(*) as row_cnt from cache_qry_param_outcomes;
...
select 'cache_outcomes_params' as table_name,count(*) as row_cnt from cache_outcomes_params;
