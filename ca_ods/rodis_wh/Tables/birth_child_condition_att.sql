CREATE TABLE [rodis_wh].[birth_child_condition_att] (
    ...
    CONSTRAINT [pk_birth_child_condition_att] PRIMARY KEY CLUSTERED ([id_birth_child_condition] ASC)
);


GO
CREATE UNIQUE NONCLUSTERED INDEX [idx_birth_child_condition_att_cd_birth_child_condition]
    ON [rodis_wh].[birth_child_condition_att]([cd_birth_child_condition] ASC);
