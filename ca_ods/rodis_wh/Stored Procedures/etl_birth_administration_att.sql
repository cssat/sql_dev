...
SELECT CONVERT(VARCHAR(50), b.bc_uni) [cd_birth_administration]
	,b.icu [fl_icu_maternal_admit]
	,b.inftrans [fl_infant_transfer]
	,b.nicu [fl_nicu_child_admit]
	,b.oproom [fl_or_maternal_admit]
	,b.anymalf [fl_malformation]
	,b.prenatmo [dt_prenatal_care_start]
	,b.urbrur [fl_urban_tract]
	,b.wic [fl_prenatal_wic_benefits]
	,b.birhour [dt_hour_birth_child]
	,b.lat [qt_latitude]
	,b.long [qt_longitude]
	,CONVERT(VARCHAR(50), b.cert) [cd_certifier_type]
	,CONVERT(VARCHAR(50), b.momtrans) [cd_maternal_transfer_type]
	,CONVERT(VARCHAR(50), b.sex) [cd_child_sex]
	,CONVERT(VARCHAR(50), b.birplace) [cd_facility_type]
	,CONVERT(VARCHAR(50), b.bc_uni) + 'C' [cd_birth_familial_child]
	,CONVERT(VARCHAR(50), b.bc_uni) + 'M' [cd_birth_familial_maternal]
	,CONVERT(VARCHAR(50), b.bc_uni) + 'P' [cd_birth_familial_paternal]
	,CONVERT(VARCHAR(50), b.bc_uni) + 'C' [cd_hospital_admission_child]
	,CONVERT(VARCHAR(50), b.bc_uni) + 'M' [cd_hospital_admission_maternal]
	,CONVERT(VARCHAR(50), b.bc_uni) [cd_birth_child_condition]
	,CONVERT(VARCHAR(50), b.bc_uni) [cd_birth_child_procedure]
	,CONVERT(VARCHAR(50), b.bc_uni) [cd_maternal_behavior]
	,CONVERT(VARCHAR(50), b.bc_uni) [cd_maternal_condition]
	,CONVERT(VARCHAR(50), b.bc_uni) [cd_maternal_history]
	,CONVERT(VARCHAR(50), b.bc_uni) [cd_maternal_procedure]
FROM rodis.berd b
