CREATE PROCEDURE [rodis_wh].[load_cause_of_death_m2m_fact]
AS
TRUNCATE TABLE rodis_wh.cause_of_death_m2m_fact

INSERT rodis_wh.cause_of_death_m2m_fact (
...
SELECT cdm.id_cause_of_death_m2m
	,cdm.cd_cause_of_death_m2m
	,cdm.id_cause_of_death
	,cdm.id_cause_of_death_order
	,cdm.id_death
...
FROM rodis_wh.cause_of_death_m2m_fat cdm
LEFT JOIN rodis_wh.death_dim dd ON dd.id_death = cdm.id_death
...
UPDATE STATISTICS rodis_wh.cause_of_death_m2m_fact
