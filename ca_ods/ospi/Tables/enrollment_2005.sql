CREATE TABLE [ospi].[enrollment_2005] (
    ...
    CONSTRAINT [PK_ospi_ye2005] PRIMARY KEY CLUSTERED ([int_researchID] ASC, [DistrictID] ASC, [SchoolCode] ASC, [DateEnrolledInSchool] ASC, [DateExitedFromSchool] ASC)
);
