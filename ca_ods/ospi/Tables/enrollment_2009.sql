CREATE TABLE [ospi].[enrollment_2009] (
    ...
    CONSTRAINT [PK_ospi_ye2009] PRIMARY KEY CLUSTERED ([int_researchID] ASC, [DistrictID] ASC, [SchoolCode] ASC, [DateEnrolledInSchool] ASC, [DateExitedFromSchool] ASC)
);
