CREATE TABLE [ospi].[enrollment_2006] (
    ...
    CONSTRAINT [PK_ospi_ye2006] PRIMARY KEY CLUSTERED ([int_researchID] ASC, [DistrictID] ASC, [SchoolCode] ASC, [DateEnrolledInSchool] ASC, [DateExitedFromSchool] ASC)
);
