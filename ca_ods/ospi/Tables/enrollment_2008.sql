CREATE TABLE [ospi].[enrollment_2008] (
    ...
    CONSTRAINT [PK_ospi_ye2008] PRIMARY KEY CLUSTERED ([int_researchID] ASC, [DistrictID] ASC, [SchoolCode] ASC, [DateEnrolledInSchool] ASC, [DateExitedFromSchool] ASC)
);
