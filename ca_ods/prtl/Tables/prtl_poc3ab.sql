CREATE TABLE [prtl].[prtl_poc3ab] (
    ...
    CONSTRAINT [PK_prtl_poc3ab_1] PRIMARY KEY CLUSTERED ([qry_type] ASC, [date_type] ASC, [start_date] ASC, [int_match_param_key] ASC, [bin_ihs_svc_cd] ASC, [cd_reporter_type] ASC, [filter_access_type] ASC, [filter_allegation] ASC, [filter_finding] ASC),
...
CREATE NONCLUSTERED INDEX [idx_prtl_poc3ab]
    ON [prtl].[prtl_poc3ab]([qry_type] ASC, [date_type] ASC, [start_date] ASC, [int_match_param_key] ASC, [cd_reporter_type] ASC, [filter_access_type] ASC, [filter_allegation] ASC, [filter_finding] ASC)
...
CREATE NONCLUSTERED INDEX [idx_qry_type_start_date]
    ...
    INCLUDE([date_type], [start_year], [int_match_param_key], [bin_ihs_svc_cd], [county_cd], [cnt_start_date], [cnt_opened], [cnt_closed], [cd_reporter_type], [filter_access_type], [filter_allegation], [filter_finding]);
