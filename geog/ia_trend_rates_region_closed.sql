...
convert(varchar,round(((case when
            (
                (case when sum(poc2ab.cnt_start_date) > 0   
                    then 
                        case when round(sum(poc2ab.cnt_start_date) + (2 * sqrt(-2 * log(max(poc2ab.x1))) * cos(2*pi()*max(poc2ab.x2))),0)  < 1
                        then 1
                        else round(sum(poc2ab.cnt_start_date) + (2 * sqrt(-2 * log(max(poc2ab.x1))) * cos(2*pi()*max(poc2ab.x2))),0) 
                        end
                    else sum(poc2ab.cnt_start_date)
                    end)		
                + 
                (case when (sum(poc2ab.cnt_opened)) > 0   
                    then 
                ...
                <  
                (case when (sum(poc2ab.cnt_closed)) > 0   
                    then 
                        case when round(sum(poc2ab.cnt_closed) + (2 * sqrt(-2 * log(max(poc2ab.x1))) * cos(2*pi()*max(poc2ab.x2))),0)  < 1
                        then 1
                        else round(sum(poc2ab.cnt_closed) + (2 * sqrt(-2 * log(max(poc2ab.x1))) * cos(2*pi()*max(poc2ab.x2))),0) 
                        end
                    else (sum(poc2ab.cnt_closed)) 
                        end)
        then 
            (
                (case when sum(poc2ab.cnt_start_date) > 0   
