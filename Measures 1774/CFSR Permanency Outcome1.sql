...
select  state_fiscal_year,filtername ,filtercode,dur_days,1.0000 - s_i  as [1-s] into prtl.cfsr_permanency_outcome_1  from @results 
 order by state_fiscal_year,filtercode;

delete  from prtl.cfsr_permanency_outcome_1  where dur_days<> 365 or filtercode=-99
