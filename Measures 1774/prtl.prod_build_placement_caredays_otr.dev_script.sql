USE [CA_ODS]
GO
/****** Object:  StoredProcedure [base].[prod_build_placement_care_days_otr]    Script Date: 12/12/2014 1:15:07 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [base].[prod_build_placement_care_days_otr]
