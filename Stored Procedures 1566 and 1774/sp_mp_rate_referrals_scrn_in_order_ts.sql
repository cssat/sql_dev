DELIMITER $$
CREATE DEFINER=`test_annie`@`localhost` PROCEDURE `sp_rate_referrals_scrn_in_order_ts`(p_date varchar(3000),p_cd_region varchar(100),p_nth_order varchar(100))
BEGIN
...
FROM rate_referrals_scrn_in_order_specific_ts AS RR
